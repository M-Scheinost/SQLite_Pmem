//tatp_transaction//TATP transaction file for Oracle/TimesTen
GET_SUBSCRIBER_DATA {
	SELECT s_id, sub_nbr, 
...
INSERT_CALL_FORWARDING {	SELECT <s_id bind subid s_id>
	...
	VALUES (<s_id value subid>, <sf_type rnd sf_type>, <start_time rnd>, <end_time rnd>, <numberx rndstr>);
} (ERRORS ALLOWED 907,3001)

// Virhekoodeja:
// 907 = Unique constraint violated
// 3001 = Foreign key violation
