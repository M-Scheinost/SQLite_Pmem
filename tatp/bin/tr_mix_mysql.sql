...
} (ERRORS ALLOWED 1205, 1213, 1452, 1216)

UPDATE_LOCATION {
	UPDATE subscriber
	SET vlr_location = <vlr_location rnd> 
	WHERE sub_nbr = <sub_nbr rndstr>;
} (ERRORS ALLOWED 1205, 1213, 1062)
...
} (ERRORS ALLOWED 1216, 1205, 1213, 1452) 
...
} (ERRORS ALLOWED 1062, 1216, 1205, 1213, 1452, 1062)

// Accepted error codes used above:
// 1062	 DB_ERROR_ALREADY_EXISTS
// 1205  Transaction timeout (or a serialization error in solidDB)
